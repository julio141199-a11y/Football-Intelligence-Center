...
## Scope gate
Only Head Coach, Assistant Coach, and Fitness Coach roles for men's or women's national teams and men's professional clubs. Women's professional clubs and academy-only roles are excluded.
...
- Only Head Coach, Assistant Coach, and Fitness Coach terms may create candidates.
...
- Notifications are allowed only for newly detected Head Coach, Assistant Coach, or Fitness Coach candidates and must label them `To Verify`.
- Chat-discovered vacancies require a public source URL and the same three-role scope gate before entering `data/chat_opportunities.json`.
...
- Placeholder URLs and all roles other than Head Coach, Assistant Coach, and Fitness Coach must fail closed.
