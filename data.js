...
const state = { jobs: [], pipelineOpportunities: [], chatOpportunities: [], contacts: [], pipelineContacts: [], socialSources: [], countries: [], licences: [], leagueIntelligence: [], updates: [], updateSchedule: null };
const text = (value) => {
...
function mergeOpportunityFeeds() {
  const merged = [...state.jobs, ...state.pipelineOpportunities.map(pipelineOpportunityToJob), ...state.chatOpportunities.map(pipelineOpportunityToJob)];
